...
export async function ExecuteSqlStatement(le:LogEngine, sqlPool:mssql.ConnectionPool, sqlQuery:string, sqlRequest:mssql.Request, logFrequency:number=1000):Promise<mssql.IResult<any>> {
